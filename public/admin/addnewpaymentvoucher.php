            ...
            <form id="summary-form" action="forms-validation.html" class="form-horizontal">
                <section class="panel">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="form-group">
                            <label class="col-sm-3 control-label">Diễn giải chi phí: <span class="required">*</span></label>
                            <div class="col-sm-6">
                        ...
                        <div class="form-group">
                            <label class="col-sm-3 control-label">Loại chi phí: <span class="required">*</span></label>
                            <div class="col-sm-6">
                                <select id="company" class="form-control" required>
                                    <option value="">Chọn loại chi phí</option>
                                    <option value="">Đồ dùng</option>
                                    <option value="">Điện nước</option>
                                    <option value="">Sửa chữa</option>
                                    <option value="">Tiền lương</option>
